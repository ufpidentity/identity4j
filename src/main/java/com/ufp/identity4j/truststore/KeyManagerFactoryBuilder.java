 ...
 * UFP Identity service.  The KeyManagerFactoryBuilder requires a
 * PKCS12 file. The PKCS12 file contains the certificate returned from
 * UFP Identity along with your private key. The PKCS12 export password
 * must be the same as the password for your private key.
 * <h4>Creating a PKCS12 file with your UFP Identity certificate and private key</h4>
 *
 * <pre>
